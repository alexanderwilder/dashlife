...
const WelcomeScreen: React.FC = () => (
  <div className="welcome-screen p-8 max-w-2xl mx-auto">
    ...
    <p className="mb-4">
      This template is a simple social media app that allows users to sign in, post images with text, and see a public
      feed.
    </p>
    <div className="mb-4">
      <img src="/public/app.png" alt="App structure diagram" className="rounded-lg shadow-md" />
    </div>
